...
_SYSTEM_PROMPT = (
    ...
    "Write the entire article in English. If the source material (claims or "
    "evidence) is written in another language, translate it faithfully into "
    "English rather than reproducing it verbatim.\n\n"
