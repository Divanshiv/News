...
| 3 RSS | Source registry, feed fetcher/parser/normalizer, ingestion job | New RSS items appear in dashboard |
| 4 Deduplication | URL normalization, title/description similarity, story merging | One event = one story with multiple sources |
